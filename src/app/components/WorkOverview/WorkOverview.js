...
const WorkOverview = () => (
    <>
        <Title>A selection of my work</Title>
        <Paragraph>
      ...
      + 'Master Digital Design</a>',
        ...
        />
        <Paragraph>
      I also build the entire video wall part of the Digital Showroom which is used by Tommy Hilfiger. Since this
      isn&apos;t an online application I can&apos;t place a link to that project here. However, you can watch
            {' '}

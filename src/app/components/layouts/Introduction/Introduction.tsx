...
const Introduction: FunctionComponent = () => (
    <>
        ...
        <Paragraph>
            {`As a kid I was spending a lot of time behind my computer, just browsing the web, playing video games and downloading music.
            However, I didn't get into coding until about 2010, when I started with my study Communication and Multimedia Design at the University of
        ...
        <Paragraph>
            {`After working at Atabix for almost four years, it was time to wrap up my education by means of a graduation internship.
            I managed to get an internship at a design studio called Momkai, where I got offered a full-time job upon completion.`}
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
            ...
            which went really well. However, I was missing the inspiration, creativity and comradery most digital agencies had to offer.

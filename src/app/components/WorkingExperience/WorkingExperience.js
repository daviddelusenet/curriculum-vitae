...
const WorkingExperience = () => (
  <React.Fragment>
    ...
    <Subtitle date="January 2018 - present">front-end developer at Random Studio</Subtitle>
    <Paragraph>
      The latest stop on my front-end developer journey: Random Studio. Random is a independent strategy and design
      studio which blurs the boundaries between art, design and technology.
    </Paragraph>
    <Paragraph>
      At Random we&apos;re primarily doing projects for high fashion brands but we&apos;re in the process of exploring
      other fields where we could be of value. Random has a real culture of participation which makes it a lot of fun
      to work there.
    </Paragraph>
    <Subtitle date="July 2016 - January 2018">front-end developer at Momkai</Subtitle>
    <Paragraph>
      After my internship ended, I started working full time at Momkai. Here I really made the next step in expanding
      my development skills. For example, I started working with React and became proficient in writing Webpack
      configurations.
    </Paragraph>
    <Paragraph>
      Momkai gave me the opportunity to work on a lot of interesting projects like the KNVB, the Master Digital Design,
      IKEA and VanMoof.
    </Paragraph>
    <Subtitle date="February 2016 - June 2016">intern front-end developer at Momkai</Subtitle>
    <Paragraph>
    ...
    <Subtitle date="March 2012 - January 2016">(intern) front-end developer at Atabix Solutions</Subtitle>
    <Paragraph>
